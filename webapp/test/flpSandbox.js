		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdeloittestripeui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdeloittestripeui-display": {
								"semanticObject": "comdeloittestripeui",
								"action": "display",
								"description": "Fiori application for Stripe Payment Integration",
								"title": "Stripe Payments",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.deloitte.stripeui",
									"url": sap.ui.require.toUrl("com/deloitte/stripeui")
								}
							}
						}
					}
